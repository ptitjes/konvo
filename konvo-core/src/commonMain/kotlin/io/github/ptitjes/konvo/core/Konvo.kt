...
class Konvo(
    ...
    private val modelProviderManager: ProviderManager<ModelCard> by instance()
    ...
    private val characterProviderManager: ProviderManager<CharacterCard> by instance()

    val models: List<ModelCard> get() = modelProviderManager.elements
