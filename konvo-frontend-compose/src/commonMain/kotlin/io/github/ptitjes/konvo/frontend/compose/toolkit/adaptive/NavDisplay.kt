...
import io.github.ptitjes.konvo.frontend.compose.toolkit.adaptive.NavDisplay.DEFAULT_TRANSITION_DURATION_MILLISECOND
import io.github.ptitjes.konvo.frontend.compose.toolkit.adaptive.NavDisplay.POP_TRANSITION_SPEC
import io.github.ptitjes.konvo.frontend.compose.toolkit.adaptive.NavDisplay.PREDICTIVE_POP_TRANSITION_SPEC
import io.github.ptitjes.konvo.frontend.compose.toolkit.adaptive.NavDisplay.TRANSITION_SPEC
...
fun <T : Any> NavDisplay(
    ...
    DecoratedNavEntryProvider(
        ...
        NavDisplayInfo(scene.entries.fastMap { it.contentKey })
...
private fun <T : Any> NavEntry<T>.predictivePopSpec():
    ...
    return metadata[PREDICTIVE_POP_TRANSITION_SPEC]
            as? AnimatedContentTransitionScope<*>.(Int) -> ContentTransform
}
