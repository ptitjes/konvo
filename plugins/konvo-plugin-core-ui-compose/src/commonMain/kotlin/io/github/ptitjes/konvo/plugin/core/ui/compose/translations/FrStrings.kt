...
internal val FrStrings = Strings(
    ...
    agents = AgentStrings(
        questionAnswerDisplayName = "Question/Réponse"
    ),
    models = ModelStrings(
        ...
        modelLabel = "Modèle",
        noAvailableModelsText = "Aucun modèle disponible",
        testAction = "Tester",
        addAction = "Ajouter",
    ...
    appearance = AppearanceStrings(
        ...
        baseColorSchemeOptionLight = "Clair",
    ...
    developer = DeveloperStrings(
        ...
        openTelemetryEndpointLabel = "Point de terminaison",
        openTelemetryVerboseLabel = "Export verbeux",
    ),
